...
# Qs to use for finding  surpluses
...
high_eq_2.5
# q = 126806.4
high_eq_5<- uniroot(function(x) demand_high(x) - 8.898776 , range(x))$root
high_eq_2.5
# q = 126806.4
...
```
a. overall wellfare of high demand consumers

```{r}
base_cs_high_1<- 
height_cs_high_1<- demand_high(0) - demand_high(255453.1)
cs_high_1<- (1/2)*base_cs_high_1*height_cs_high_1
cs_high_1
# 4230688
