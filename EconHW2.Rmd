...
low_CS_1 <- (1/2)*low_base_1*low_height_1
low_CS_1 #Low demand CS = 969643.1
...
low_CS_2.5 <- (1/2)*low_base_2.5*low_height_2.5
low_CS_2.5 #Low demand CS = 834763.2
...
low_CS_5 <- (1/2)*low_base_5*low_height_5
low_CS_5 #High demand CS = 632400.3

# LOW DEMAND CONSUMER SUMMARY:
#(No tax  ): High demand welfare is $1065136 
#($0.5 Tax): High demand welfare is $989249.3
#($1 Tax  ): High demand welfare is $969643.1
#($2.5 Tax): High demand welfare is $834763.2
#($5 Tax  ): High demand welfare is $632400.3
...
ps_1_base<- 255453
ps_1_height<- taxfxn_1(5.779527) -  taxfxn_1(0)
ps_1<- (1/2)*ps_1_base*ps_1_height
# ps for a 1$ tax = 13.8117
...
ps_2.5_height<- taxfxn_2.5(6.949245) - taxfxn_2.5(0)
ps_2.5<- (1/2)*ps_2.5_base*ps_2.5_height
ps_2.5
# PS under a $2.5 tax = 15.45944
...
ps_5_base<- 208379.2
ps_5_height<- taxfxn_5(8.898776) - taxfxn_5(0)
ps_5<- (1/2)*ps_5_base*ps_5_height
ps_5
# PS under the $5 tax = 17.34716
